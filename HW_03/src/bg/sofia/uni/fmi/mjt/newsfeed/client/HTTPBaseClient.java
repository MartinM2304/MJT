...
public class HTTPBaseClient<T> implements Client<T> {
    ...
    private List<T> execute(int page)
            throws ClientSendException, JSONParsingException {
        ...
        if (totalResultsElement != null && totalResultsElement.isJsonPrimitive()) {
            ...
            throw new JSONParsingException("totalResults cant be parsed");
        }
    ...
    public HTTPBaseClientBuilder<T> builder(HttpClient client, Request request,
                                            Function<String, PagedResponse<T>> parser) {
    ...
    public static class HTTPBaseClientBuilder<T> {
        ...
        public HTTPBaseClientBuilder(HttpClient httpClient, Request request,
                                     Function<String, PagedResponse<T>> parser) {
